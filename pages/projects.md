...
{% for project in site.data.projects %}
  <li class="project-card">
    ...
    <span class="meta" data-i18n="en">{{ project.tech }}{% if project.repo != "" %} · <a href="{{ project.repo }}">Repo</a>{% endif %}{% if project.demo != "" %} / <a href="{{ project.demo }}">Demo</a>{% endif %}</span>
    <span class="meta" data-i18n="zh">{{ project.tech }}{% if project.repo != "" %} · <a href="{{ project.repo }}">代码库</a>{% endif %}{% if project.demo != "" %} / <a href="{{ project.demo }}">演示</a>{% endif %}</span>
  </li>
{% endfor %}
</ul>
